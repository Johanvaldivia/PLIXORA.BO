...
window.catalogData = [
    ...
    // ── COMBOS ──
    { id: 'cb-stream', name: 'Combo Stream',          type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 32,  cost: 24.2, profit: 7.8, features: ['Disney+', 'YouTube Premium'], comboServices: ['Disney+', 'YouTube Premium'], accountsCount: 2 },
    { id: 'cb-diseno', name: 'Combo Diseño',          type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 80,  cost: 50,   profit: 30, features: ['Canva EDU', 'Adobe Creative Cloud'], comboServices: ['Canva EDU', 'Adobe Creative Cloud'], accountsCount: 2 },
    { id: 'cb-creator',name: 'Combo Creator Pro',     type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 125, cost: 110,  profit: 15, features: ['CapCut Pro', 'Adobe Creative Cloud'], comboServices: ['CapCut Pro', 'Adobe Creative Cloud'], accountsCount: 2 },
    { id: 'cb-office', name: 'Combo Office',          type: 'combo',  category: 'combo',      duration: '1 año',    salePrice: 160, cost: 100,  profit: 60, features: ['Microsoft 365', 'Canva EDU'], comboServices: ['Microsoft 365', 'Canva EDU'], accountsCount: 2 },
    { id: 'cb-ultra',  name: 'Combo Ultra',           type: 'combo',  category: 'combo',      duration: 'Mix',      salePrice: 210, cost: 150,  profit: 60, features: ['Microsoft 365', 'Adobe', 'Canva EDU'], comboServices: ['Microsoft 365', 'Adobe', 'Canva EDU'], accountsCount: 3 },
    { id: 'cb-privado',name: 'Combo Privado',         type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 45,  cost: 36,   profit: 9,  features: ['Express VPN', 'YouTube Premium'], comboServices: ['Express VPN', 'YouTube Premium'], accountsCount: 2 },
