...
window.catalogData = [
    ...
    // ── COMBOS ──
    { id: 'cb-stream', name: 'Combo Stream',          type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 32,  cost: 24.2, profit: 7.8, features: ['Disney+', 'YouTube Premium'], comboServices: [{ name: 'Disney+', duration: '1 mes' }, { name: 'YouTube Premium', duration: '1 mes' }], accountsCount: 2 },
    { id: 'cb-diseno', name: 'Combo Diseño',          type: 'combo',  category: 'combo',      duration: '1 mes / 1 año', salePrice: 80,  cost: 50,   profit: 30, features: ['Canva EDU (1 año)', 'Adobe Creative Cloud (1 mes)'], comboServices: [{ name: 'Canva EDU', duration: '1 año' }, { name: 'Adobe Creative Cloud', duration: '1 mes' }], accountsCount: 2 },
    { id: 'cb-creator',name: 'Combo Creator Pro',     type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 125, cost: 110,  profit: 15, features: ['CapCut Pro', 'Adobe Creative Cloud'], comboServices: [{ name: 'CapCut Pro', duration: '1 mes' }, { name: 'Adobe Creative Cloud', duration: '1 mes' }], accountsCount: 2 },
    { id: 'cb-office', name: 'Combo Office',          type: 'combo',  category: 'combo',      duration: '1 año',    salePrice: 160, cost: 100,  profit: 60, features: ['Microsoft 365', 'Canva EDU'], comboServices: [{ name: 'Microsoft 365', duration: '1 año' }, { name: 'Canva EDU', duration: '1 año' }], accountsCount: 2 },
    { id: 'cb-ultra',  name: 'Combo Ultra',           type: 'combo',  category: 'combo',      duration: 'Mix',      salePrice: 210, cost: 150,  profit: 60, features: ['Microsoft 365 (1 año)', 'Adobe (1 mes)', 'Canva EDU (1 año)'], comboServices: [{ name: 'Microsoft 365', duration: '1 año' }, { name: 'Adobe', duration: '1 mes' }, { name: 'Canva EDU', duration: '1 año' }], accountsCount: 3 },
    { id: 'cb-privado',name: 'Combo Privado',         type: 'combo',  category: 'combo',      duration: '1 mes',    salePrice: 45,  cost: 36,   profit: 9,  features: ['Express VPN', 'YouTube Premium'], comboServices: [{ name: 'Express VPN', duration: '1 mes' }, { name: 'YouTube Premium', duration: '1 mes' }], accountsCount: 2 },
